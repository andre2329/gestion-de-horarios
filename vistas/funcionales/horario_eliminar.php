        ...
        <script>
            ...
            <table class="mx-auto">
                ...
                <tbody>
                    <tr>
                        <td colspan="2">
                            C&oacute;digo de la secci&oacute;n
                        </td>
                        <td>
                            <input disabled="true" class="form-control" type="text" name="seccion" id="seccion"
                    ...
                    <tr>
                        <td width=20%>
                            <input disabled="true"  class="form-control" type="time" step="3600000" min="07:00" max="22:00" 
                        ...
                        <td width=20%>
                            <select class="form-control"  name="dia" id="dia" disabled="true" >
                                <?php 
                                $lunes="";
                                $martes="";
                                $miercoles="";
                        ...
                        <td width=20%>
                            <select disabled="true"  class="form-control"  name="docente" id="docente">
                        ...
                        <td width=20%>
                            <select disabled="true"  class="form-control"  name="campus" onchange="obtenerAula(this.value,'aula','<?php echo $horario['tipo'] ?>')" id="campus">
                        ...
                        <td width=20%>
                            <select disabled="true"  class="form-control"  name="aula" id="aula">
                                <option value="" hidden>...</option>
                                <?php echo $stringAula ?>
                            </select>
                        </td>
    ...
    <div class="modal-propio">
        <div class="contenedor-modal">
            <div class="d-flex justify-content-between align-middle align-items-center">
                <h4 class="d-inline-block p-4" id="titulo-modal">&iquest;Est&aacute; seguro que quiere eliminar este curso&#63;</h4>

                <label class="d-inline-block p-2 " for="btn-modal"><i class="fa fa-times" id="salir-modal"></i></label>
            </div>
            <hr class="p-4">
            <div class="contenido-modal p-4">
                <label class="btn btn-dark text-light" onclick="eliminarHorario()">Aceptar</label>
