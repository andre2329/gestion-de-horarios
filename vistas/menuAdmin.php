...
<body>
    ...
    <div class="d-flex ">
        ...
        $hola = __DIR__.'/complementarios/sideBarAdmin.php';
        require_once $hola;
        ?>
        ...
        <div class="text-center col-md-12 px-0 align-middle header-principal" style="z-index: 900; ">
            ...
            <div class="text-light text-center bg-dark px-0 align-middle text-center d-flex justify-content-between align-items-center encabezado " style="height: 92px;">
                ...
                <ul style="list-style: none; height: 100%;" class="d-flex align-middle align-items-center menu-area-2">
                    ...
                    >
                        <a href="# " class="d-block p-2 text-light "
                        ...
                        <ul class="d-block text-dark">
                            <!--
<li class="d-block text-dark mr-5">
                                <a class="d-block p-2 text-light text-dark " href="# ">Mis datos</a>
                                <hr>
                            </li>
                            -->
                            
                            <li class="d-block text-dark ">
                                <a class="d-block p-2 text-light  text-dark" href="# ">Cambiar contrase&ntilde;a</a>
                                <hr>
                            </li>
                            <li class="d-block text-dark">
    ...
    <div id="main1" class="text-center align-middle col-md-8" style="background-color: white;">
        ...
        <hr>
        <p>Usted se encuentra en el modo administrador. Nos encontramos en el semestre 2020-2. Los horarios de Ing. Electrónica se encuentran ingresados en un 78% y los horarios de Ing. Mecatrónica al 90%.</p>
    </div>
    <br>
        ...
        <table class="col-md-12 table">
            <thead>
                <tr>
                    ...
                    <th style="width: 25%;">Horarios</th>
                    <th style="width: 25%;">Ocupabilidad</th>
                    <th style="width: 25%;">Mallas</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    <td>
                        <a class="text-dark" href="# " onclick="insertardocente()">Insertar docente</a>
                    </td>
                    <td>
                        <a class="text-dark" href="# " onclick="clickCrearNuevoCurso()">Crear un horario de un curso</a>
                    </td>
                    <td>
                        <a class="text-dark" href="# " onclick="verOcupabilidad()">Ver ocupabilidad</a>
                    </td>
                    <td>
                        <a class="text-dark" href="# " onclick="clickMalla('nuevo')">Insertar nuevo curso</a>
                    </td>
                </tr>
                <tr>
                    <td>
                        <a class="text-dark" href="# " onclick="insertardisponibilidad()">Insertar disponibilidad docente</a>
                    </td>
                    <td>
                        <a class="text-dark" href="# " onclick="modificarHorarioCurso()">Modificar un horario de un curso</a>
                    </td>
                    <td>
                        
                    </td>
                    <td>
                        <a class="text-dark" href="# " onclick="clickMalla('editar')">Editar cursos</a>
                    </td>
                </tr>
                <tr>
                    <td>
                        <a class="text-dark" href="# " onclick="editardocente()">Editar datos docente</a>
                    </td>
                    <td>
                        <a class="text-dark" href="# " onclick="eliminarHorarioCurso()">Eliminar un horario</a>
                    </td>

                </tr>
                <tr>
                    <td>
                        <a class="text-dark" href="# " onclick="verhorariopropuesto()">Ver horario propuesto docente</a>
                    </td>
                    <td>
                        <a class="text-dark" href="# " onclick="verHorariosPorCurso()">Ver horarios por curso</a>
                    </td>
                </tr>
                <tr>
                    <td>
                        <a class="text-dark" href="# " onclick="resumendisponibilidad()">Ver disponibilidad docente</a>
                    </td>
                    <td>
                        <a class="text-dark" href="# " onclick="verHorariosPorCiclo()">Ver horarios por ciclo</a>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <a class="text-dark" href="# " onclick="verHorariosPorCarrera()">Ver todos los horarios por carrera</a>
                    </td>
                </tr>
            </tbody>
        </table>
